...
export class CreateTourDto {
    ...
    @ApiProperty({ example: 'amazing-vietnam-tour', description: 'URL‑friendly slug' })
    @IsString()
    slug: string;

    @ApiPropertyOptional({ example: 'https://res.cloudinary.com/.../thumbnail.jpg', description: 'Thumbnail image URL' })
    @IsOptional()
    @IsString()
    thumbnail: string;
    ...
    @ApiProperty({ example: 'Explore the hidden gems of Vietnam...', description: 'Short description' })
    @IsString()
    description: string;

    @ApiProperty({ example: '<p>Full HTML content of the tour...</p>', description: 'Detailed content (HTML)' })
    @IsString()
    content: string;
    ...
    @ApiProperty({ example: 'Hanoi → Ha Long → Hue → Hoi An', description: 'Route description' })
    @IsString()
    routes: string;
